...
- [`load_metadata()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/load_metadata.md):
  Load station inventory used by all download wrappers.
- [`sync_metadata()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/sync_metadata.md):
  Checks and updates metadata from the official station inventory CSV.
- [`download_station_month()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/download_station_month.md):
  Download one station, one year, one month.
- [`download_station_by_name()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/download_station_by_name.md):
  Download one station for a year range.
- [`download_station_province()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/download_station_province.md):
  Download all stations in one province.
- [`download_all_station()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/download_all_station.md):
  Download all stations in your metadata.
- [`download_metadata()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/download_metadata.md):
  Copy packaged metadata `.rds` to your output folder.
...
Use
[`sync_metadata()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/sync_metadata.md)
to pull the most recent station metadata and update local metadata. This
will only change when new station metadata is available.
...
The default directory is your current working directory but it can be
specified ot be anything you like.
...
After creating your database, you can run missing-data and range
diagnostics.
...
Use
[`heatwave_diagnostics()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/heatwave_diagnostics.md)
to detect heatwave events defined as two or more consecutive hot days. A
day is flagged when either daily maximum temperature is above
`mean + 5 * sd` or daily average temperature is above `mean + 3 * sd`
...
Use
[`plot_station_outliers()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/plot_station_outliers.md)
to visualize a station across variables and highlight points outside the
SD threshold in red.
...
- Metadata and paths:
  - [`.load_station_metadata()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-load_station_metadata.md)
  - [`.resolve_out_dir()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-resolve_out_dir.md)
  - [`.sync_station_metadata()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-sync_station_metadata.md)
- Name and province resolution:
  - [`.normalize_station_name_key()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-normalize_station_name_key.md)
  - [`.find_station_name_index()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-find_station_name_index.md)
  - [`.province_normalize()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-province_normalize.md)
- Validation and safety:
  - [`.validate_year()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-validate_year.md)
  - [`.estimate_download_size()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-estimate_download_size.md)
  - `.check_disk_space()`
  - [`.is_valid_downloaded_month_file()`](https://joeyfrost-xenopoulos.github.io/Drifloon/reference/dot-is_valid_downloaded_month_file.md)
